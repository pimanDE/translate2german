...
<br>
<br>
Mit diesem Script wird die Weboberfläche Version **v6.5.1** des Pi-hole auf deutsch übersetzt.
<br>
<br>
**Screenshot:**
...
- getestet unter Pi-hole Version v6.4.2, FTL Version v6.6.2 und Web Interface Version **v6.5.1**
